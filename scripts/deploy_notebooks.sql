...
CREATE OR REPLACE NOTEBOOK IDENTIFIER('"FRED_DB"."{{env}}_{{schm}}"."{{env}}_01_load_files"')
...
ALTER NOTEBOOK "FRED_DB"."{{env}}_{{schm}}"."{{env}}_01_load_files" ADD LIVE VERSION FROM LAST;
